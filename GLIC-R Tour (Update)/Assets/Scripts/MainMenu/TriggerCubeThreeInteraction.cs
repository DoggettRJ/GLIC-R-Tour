...
public class TriggerCubeThreeInteraction : MonoBehaviour
{
    [SerializeField]
    ...
    public GameObject TriggerGrabVP;
    ...
    protected virtual void HandHoverUpdate(Hand hand)
    {
        ...
        if (startingGrabType != GrabTypes.None)
        {
            if (startingGrabType == GrabTypes.Pinch)
            {
                ...
                //else if (!RobotButtonArrow.activeInHierarchy)
                // {
                //SelectYourLightSettings.SetActive(true);
                // }
                ...
                // ResetRobot.SetActive(false);
                // RunRobot.SetActive(true);
