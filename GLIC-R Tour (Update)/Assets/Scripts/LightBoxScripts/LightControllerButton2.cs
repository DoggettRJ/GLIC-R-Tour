...
public class LightControllerButton2 : MonoBehaviour
{
    [SerializeField]
   ...
   // public GameObject SelectYourLightSettings;
    ...
    protected virtual void HandHoverUpdate(Hand hand)
    {
        ...
        if (startingGrabType != GrabTypes.None)
        {
            ...
            {
                if (lightHint.activeInHierarchy)
                {
                    spotLight.intensity = 6f;

                    bulbMaterial.EnableKeyword("_EMISSION");
                    indicator1.DisableKeyword("_EMISSION");
                    indicator2.EnableKeyword("_EMISSION");
                    indicator3.DisableKeyword("_EMISSION");
                    LightControlDummy.SetActive(true);

                    LightArrow.SetActive(false);
                    CameraArrow.SetActive(true);

                    LightLowDummy.SetActive(false);
                    LightMedDummy.SetActive(true);
                    LightHighDummy.SetActive(false);
                    // SelectYourLightSettings.SetActive(false);
                }
            }
            ...
            switch (startingGrabType)
            {
                ...
                case GrabTypes.Trigger:
                    ...
                    break;
                default:
                    Debug.Log("Debug is the workings now?");
