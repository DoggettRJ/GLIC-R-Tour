...
public class TMProSkewText : MonoBehaviour
{
    ...
    [SerializeField]
    private float shearAmount = 1.0f;
    [SerializeField]
    private AnimationCurve vertexCurve = new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.25f, 2.0f), new Keyframe(0.5f, 0), new Keyframe(0.75f, 2.0f), new Keyframe(1, 0f));
    ...
    public void CurveUpdate(float curveScale)
    {
        this.curveScale = curveScale;
        WarpTextImmediate();
    }

    public void ShearUpdate(float shearAmount)
    {
        this.shearAmount = shearAmount;
        WarpTextImmediate();
    }

    private void WarpTextImmediate()
    {
